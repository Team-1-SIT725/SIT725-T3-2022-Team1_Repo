$(document).ready(function () {
    ...
    // $("#addFileSubmit").click(submitForm);
...
const submitAddFile = () => {
    // let formData = document.querySelector("#addFileForm").form;
    let formData = new FormData(document.querySelector("#addFileForm"));

    // let formData = $("#addFileForm").form;
    // const formData = new FormData($("#addFileForm").target);
    // let formData = {};
    ...
    addFileToApp(formData);
};

//ajax
const addFileToApp = (formData) => {
    $.ajax({
        url: "/api/item/add",
        data: formData,
        type: "POST",
